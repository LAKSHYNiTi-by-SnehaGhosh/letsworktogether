...
export default async function CalendarPage() {
  ...
  try {
    ...
    console.error("Clerk auth error in CalendarPage:", authErr);
    redirect("/sign-in");
  }
  ...
  try {
    ...
    const activeProjectsCount = user?.projectMemberships?.length ?? 0;
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="rounded-xl border border-border bg-card p-12 shadow-sm text-center">
          ...
          <p className="text-muted-foreground max-w-md mx-auto mb-6">
            The calendar view is currently under development. Soon you&apos;ll be able to see milestones for your {activeProjectsCount} active projects here.
          </p>
    ...
    console.error("Error rendering CalendarPage:", error);
    return (
      <div className="max-w-5xl mx-auto space-y-8">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Calendar</h1>
